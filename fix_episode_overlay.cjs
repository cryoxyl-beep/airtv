...
code = code.replace(
  /className=\{`relative aspect-video rounded-xl overflow-hidden bg-\[#141414\] border transition-all duration-300 shadow-lg \$\{isActive \? 'border-white\/50 shadow-\[0_0_20px_rgba\(255,255,255,0\.15\)\]' : 'border-white\/10 group-hover:border-white\/30'\}`\}/,
